...
public class ProcessDefinitionDTO {
	...
	public String toString() {
		return "ProcessDefinitionDTO [id=" + id + ", category=" + category + ", name=" + name + ", key=" + key
				+ ", description=" + description + ", version=" + version + ", resourceName=" + resourceName
				+ ", deploymentId=" + deploymentId + ", diagramResourceName=" + diagramResourceName + ", tenantId="
				+ tenantId + ", startFormKey=" + startFormKey + ", graphicalNotation=" + graphicalNotation
				+ ", suspended=" + suspended + "]";
	}
